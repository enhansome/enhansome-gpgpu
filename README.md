...
* 🟢 [Bullet](http://bulletphysics.org/wordpress/) - Real-Time Physics Simulation (Bullet 3 includes the optional work-in-progress GPU pipeline.) [⭐ 14.5k](https://github.com/bulletphysics/bullet3) ⭐ 14,692 | 🐛 424 | 🌐 C++ | 📅 2025-10-22
...
* 🟢 [CLBlast](https://cnugteren.github.io/clblast/clblast.html) - Modern, lightweight, performant and tunable OpenCL BLAS library written in C++11 [⭐ 1.2k](https://github.com/CNugteren/CLBlast) ⭐ 1,186 | 🐛 54 | 🌐 C++ | 📅 2026-04-13
...
* 🔴 [Basic examples of OpenCL with the C++ API](https://github.com/Dakkers/OpenCL-examples) ⭐ 181 | 🐛 3 | 🌐 C | 📅 2019-03-26 [⭐ 180](https://github.com/Dakkers/OpenCL-examples) ⭐ 181 | 🐛 3 | 🌐 C | 📅 2019-03-26
